...
def live_update():
    ...
    params = _harmonize(params)  # ensure CPP window aligns with main calculator
    ...
    mc_params = dict(
        ...
        num_simulations=params.get("num_simulations", params.get("n_sims", 2000)),
